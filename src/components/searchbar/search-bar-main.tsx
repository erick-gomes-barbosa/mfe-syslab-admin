  ...
  return (
    <div className="flex justify-center w-full">
      <input
        ...
        type="text"
        className=" pl-7 py-1 outline-none border-2 max-w-[600px] w-full bg-white border-grayPrimary rounded-l-lg border-r-[1px] font-normal text-base placeholder-grayPrimary"
      />
